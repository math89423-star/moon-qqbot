...
warnings.warn(
    "peer_isolation 导入路径已过时, 请改用 astrbot_plugin_suli_guards",
    DeprecationWarning,
    stacklevel=2,
)

from astrbot_plugin_suli_guards.peer_isolation import PeerIsolation  # noqa: E402, F401

__all__ = ["PeerIsolation"]
